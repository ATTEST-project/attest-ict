...
import static com.attest.ict.test.util.OAuth2TestUtil.ID_TOKEN;
import static com.attest.ict.test.util.OAuth2TestUtil.authenticationToken;
import static com.attest.ict.test.util.OAuth2TestUtil.registerAuthenticationToken;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.post;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.attest.ict.IntegrationTest;
import com.attest.ict.security.AuthoritiesConstants;
...
class LogoutResourceIT {
    ...
    void getLogoutInformation() throws Exception {
        final String ORIGIN_URL = "http://localhost:9090";
        String logoutUrl =
        ...
        restLogoutMockMvc
            .perform(post("http://localhost:9090/api/logout").header(HttpHeaders.ORIGIN, ORIGIN_URL))
