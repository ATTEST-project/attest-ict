...
/**
 * Criteria class for the {@link com.attest.ict.domain.GenProfile} entity. This class is used
 * in {@link com.attest.ict.web.rest.GenProfileResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /gen-profiles?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class GenProfileCriteria implements Serializable, Criteria {
    ...
    public GenProfileCriteria() {}

    public GenProfileCriteria(GenProfileCriteria other) {
    ...
    @Override
    public GenProfileCriteria copy() {
        return new GenProfileCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final GenProfileCriteria that = (GenProfileCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, season, typicalDay, mode, timeInterval, uploadDateTime, inputFileId, genElValId, networkId, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "GenProfileCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
