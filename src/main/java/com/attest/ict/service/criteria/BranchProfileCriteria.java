...
/**
 * Criteria class for the {@link com.attest.ict.domain.BranchProfile} entity. This class is used
 * in {@link com.attest.ict.web.rest.BranchProfileResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /branch-profiles?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class BranchProfileCriteria implements Serializable, Criteria {
    ...
    public BranchProfileCriteria() {}

    public BranchProfileCriteria(BranchProfileCriteria other) {
    ...
    @Override
    public BranchProfileCriteria copy() {
        return new BranchProfileCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final BranchProfileCriteria that = (BranchProfileCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, season, typicalDay, mode, timeInterval, uploadDateTime, inputFileId, branchElValId, networkId, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "BranchProfileCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
