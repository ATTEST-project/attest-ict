...
/**
 * A DTO for the {@link com.attest.ict.domain.LoadProfile} entity.
 */
public class LoadProfileDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LoadProfileDTO)) {
            return false;
        }

        LoadProfileDTO loadProfileDTO = (LoadProfileDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, loadProfileDTO.id);
    }
