...
/**
 * A DTO for the {@link com.attest.ict.domain.BranchProfile} entity.
 */
public class BranchProfileDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BranchProfileDTO)) {
            return false;
        }

        BranchProfileDTO branchProfileDTO = (BranchProfileDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, branchProfileDTO.id);
    }
