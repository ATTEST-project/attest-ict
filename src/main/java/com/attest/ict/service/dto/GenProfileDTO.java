...
/**
 * A DTO for the {@link com.attest.ict.domain.GenProfile} entity.
 */
public class GenProfileDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GenProfileDTO)) {
            return false;
        }

        GenProfileDTO genProfileDTO = (GenProfileDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, genProfileDTO.id);
    }
