...
export const NodeDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="attestApp.node.delete.question">Are you sure you want to delete this Node?</ModalBody>
      <ModalFooter>
