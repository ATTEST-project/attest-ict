...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './generator-extension.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GENERATOREXTENSION_LIST actions', async () => {
    ...
    it('dispatches FETCH_GENERATOREXTENSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GENERATOREXTENSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GENERATOREXTENSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GENERATOREXTENSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GENERATOREXTENSION actions', async () => {
      const expectedActions = [
        {
