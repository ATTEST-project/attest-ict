...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bus-name.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BUSNAME_LIST actions', async () => {
    ...
    it('dispatches FETCH_BUSNAME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BUSNAME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BUSNAME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BUSNAME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BUSNAME actions', async () => {
      const expectedActions = [
        {
