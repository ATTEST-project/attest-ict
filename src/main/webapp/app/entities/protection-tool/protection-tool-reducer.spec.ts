...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROTECTIONTOOL_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROTECTIONTOOL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROTECTIONTOOL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROTECTIONTOOL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROTECTIONTOOL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROTECTIONTOOL actions', async () => {
      const expectedActions = [
        {
