...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './asset-transformer.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ASSETTRANSFORMER_LIST actions', async () => {
    ...
    it('dispatches FETCH_ASSETTRANSFORMER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ASSETTRANSFORMER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ASSETTRANSFORMER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ASSETTRANSFORMER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ASSETTRANSFORMER actions', async () => {
      const expectedActions = [
        {
