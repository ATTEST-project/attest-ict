...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BRANCHPROFILE_LIST actions', async () => {
    ...
    it('dispatches FETCH_BRANCHPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BRANCHPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BRANCHPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BRANCHPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BRANCHPROFILE actions', async () => {
      const expectedActions = [
        {
