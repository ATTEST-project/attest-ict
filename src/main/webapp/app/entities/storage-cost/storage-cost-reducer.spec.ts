...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STORAGECOST_LIST actions', async () => {
    ...
    it('dispatches FETCH_STORAGECOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STORAGECOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STORAGECOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STORAGECOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STORAGECOST actions', async () => {
      const expectedActions = [
        {
