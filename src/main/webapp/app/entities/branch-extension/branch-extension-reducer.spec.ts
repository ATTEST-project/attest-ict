...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BRANCHEXTENSION_LIST actions', async () => {
    ...
    it('dispatches FETCH_BRANCHEXTENSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BRANCHEXTENSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BRANCHEXTENSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BRANCHEXTENSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BRANCHEXTENSION actions', async () => {
      const expectedActions = [
        {
