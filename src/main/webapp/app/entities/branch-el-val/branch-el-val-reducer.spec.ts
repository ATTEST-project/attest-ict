...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BRANCHELVAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_BRANCHELVAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BRANCHELVAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BRANCHELVAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BRANCHELVAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BRANCHELVAL actions', async () => {
      const expectedActions = [
        {
