...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './network.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NETWORK_LIST actions', async () => {
    ...
    it('dispatches FETCH_NETWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NETWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NETWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NETWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NETWORK actions', async () => {
      const expectedActions = [
        {
