...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GENELVAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_GENELVAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GENELVAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GENELVAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GENELVAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GENELVAL actions', async () => {
      const expectedActions = [
        {
