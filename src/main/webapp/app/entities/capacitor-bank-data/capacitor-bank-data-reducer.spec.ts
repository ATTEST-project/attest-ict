...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './capacitor-bank-data.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CAPACITORBANKDATA_LIST actions', async () => {
    ...
    it('dispatches FETCH_CAPACITORBANKDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CAPACITORBANKDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CAPACITORBANKDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CAPACITORBANKDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CAPACITORBANKDATA actions', async () => {
      const expectedActions = [
        {
