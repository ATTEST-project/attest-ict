...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSFORMER_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRANSFORMER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRANSFORMER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRANSFORMER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRANSFORMER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRANSFORMER actions', async () => {
      const expectedActions = [
        {
