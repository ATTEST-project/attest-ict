...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './generator.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GENERATOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_GENERATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GENERATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GENERATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GENERATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GENERATOR actions', async () => {
      const expectedActions = [
        {
