...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOPOLOGYBUS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOPOLOGYBUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOPOLOGYBUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOPOLOGYBUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOPOLOGYBUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOPOLOGYBUS actions', async () => {
      const expectedActions = [
        {
