...
export const StorageDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="attestApp.storage.delete.question">Are you sure you want to delete this Storage?</ModalBody>
      <ModalFooter>
