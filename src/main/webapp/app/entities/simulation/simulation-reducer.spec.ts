...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SIMULATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_SIMULATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SIMULATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SIMULATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SIMULATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SIMULATION actions', async () => {
      const expectedActions = [
        {
