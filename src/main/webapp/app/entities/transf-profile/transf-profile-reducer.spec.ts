...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSFPROFILE_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRANSFPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRANSFPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRANSFPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRANSFPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRANSFPROFILE actions', async () => {
      const expectedActions = [
        {
