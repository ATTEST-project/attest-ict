...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOADPROFILE_LIST actions', async () => {
    ...
    it('dispatches FETCH_LOADPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOADPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOADPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOADPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOADPROFILE actions', async () => {
      const expectedActions = [
        {
