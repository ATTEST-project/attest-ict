...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VOLTAGELEVEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_VOLTAGELEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VOLTAGELEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VOLTAGELEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VOLTAGELEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VOLTAGELEVEL actions', async () => {
      const expectedActions = [
        {
