...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BUSCOORDINATE_LIST actions', async () => {
    ...
    it('dispatches FETCH_BUSCOORDINATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BUSCOORDINATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BUSCOORDINATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BUSCOORDINATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BUSCOORDINATE actions', async () => {
      const expectedActions = [
        {
