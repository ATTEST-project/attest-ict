...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BILLINGDER_LIST actions', async () => {
    ...
    it('dispatches FETCH_BILLINGDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BILLINGDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BILLINGDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BILLINGDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BILLINGDER actions', async () => {
      const expectedActions = [
        {
