...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OUTPUTFILE_LIST actions', async () => {
    ...
    it('dispatches FETCH_OUTPUTFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OUTPUTFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OUTPUTFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OUTPUTFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OUTPUTFILE actions', async () => {
      const expectedActions = [
        {
