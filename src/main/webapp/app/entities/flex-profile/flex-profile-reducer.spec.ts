...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FLEXPROFILE_LIST actions', async () => {
    ...
    it('dispatches FETCH_FLEXPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FLEXPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FLEXPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FLEXPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FLEXPROFILE actions', async () => {
      const expectedActions = [
        {
