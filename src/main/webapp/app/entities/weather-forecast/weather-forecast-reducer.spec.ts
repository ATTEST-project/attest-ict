...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WEATHERFORECAST_LIST actions', async () => {
    ...
    it('dispatches FETCH_WEATHERFORECAST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WEATHERFORECAST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WEATHERFORECAST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WEATHERFORECAST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WEATHERFORECAST actions', async () => {
      const expectedActions = [
        {
