...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FLEXELVAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_FLEXELVAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FLEXELVAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FLEXELVAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FLEXELVAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FLEXELVAL actions', async () => {
      const expectedActions = [
        {
