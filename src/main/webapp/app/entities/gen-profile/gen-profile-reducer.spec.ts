...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GENPROFILE_LIST actions', async () => {
    ...
    it('dispatches FETCH_GENPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GENPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GENPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GENPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GENPROFILE actions', async () => {
      const expectedActions = [
        {
