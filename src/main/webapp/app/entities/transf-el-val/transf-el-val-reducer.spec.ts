...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSFELVAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRANSFELVAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRANSFELVAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRANSFELVAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRANSFELVAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRANSFELVAL actions', async () => {
      const expectedActions = [
        {
