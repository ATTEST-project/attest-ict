...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOOLPARAMETER_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOOLPARAMETER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOOLPARAMETER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOOLPARAMETER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOOLPARAMETER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOOLPARAMETER actions', async () => {
      const expectedActions = [
        {
