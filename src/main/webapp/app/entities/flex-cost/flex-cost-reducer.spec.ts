...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './flex-cost.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FLEXCOST_LIST actions', async () => {
    ...
    it('dispatches FETCH_FLEXCOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FLEXCOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FLEXCOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FLEXCOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FLEXCOST actions', async () => {
      const expectedActions = [
        {
