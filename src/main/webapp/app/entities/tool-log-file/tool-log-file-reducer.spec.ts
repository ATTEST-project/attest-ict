...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOOLLOGFILE_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOOLLOGFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOOLLOGFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOOLLOGFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOOLLOGFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOOLLOGFILE actions', async () => {
      const expectedActions = [
        {
