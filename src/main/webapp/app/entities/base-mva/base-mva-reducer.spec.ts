...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './base-mva.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BASEMVA_LIST actions', async () => {
    ...
    it('dispatches FETCH_BASEMVA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BASEMVA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BASEMVA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BASEMVA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BASEMVA actions', async () => {
      const expectedActions = [
        {
