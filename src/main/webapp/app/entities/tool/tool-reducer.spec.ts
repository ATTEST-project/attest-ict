...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tool.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOOL_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOOL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOOL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOOL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOOL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOOL actions', async () => {
      const expectedActions = [
        {
