...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INPUTFILE_LIST actions', async () => {
    ...
    it('dispatches FETCH_INPUTFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INPUTFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INPUTFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INPUTFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INPUTFILE actions', async () => {
      const expectedActions = [
        {
