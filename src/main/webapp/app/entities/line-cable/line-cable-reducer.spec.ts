...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LINECABLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_LINECABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LINECABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LINECABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LINECABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LINECABLE actions', async () => {
      const expectedActions = [
        {
