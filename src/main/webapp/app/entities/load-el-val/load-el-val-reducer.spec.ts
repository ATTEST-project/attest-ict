...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOADELVAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_LOADELVAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOADELVAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOADELVAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOADELVAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOADELVAL actions', async () => {
      const expectedActions = [
        {
