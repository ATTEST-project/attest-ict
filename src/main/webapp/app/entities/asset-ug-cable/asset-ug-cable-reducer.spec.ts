...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ASSETUGCABLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ASSETUGCABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ASSETUGCABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ASSETUGCABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ASSETUGCABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ASSETUGCABLE actions', async () => {
      const expectedActions = [
        {
