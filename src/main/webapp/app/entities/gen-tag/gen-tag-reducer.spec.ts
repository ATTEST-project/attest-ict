...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './gen-tag.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GENTAG_LIST actions', async () => {
    ...
    it('dispatches FETCH_GENTAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GENTAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GENTAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GENTAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GENTAG actions', async () => {
      const expectedActions = [
        {
