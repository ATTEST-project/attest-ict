...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './topology.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOPOLOGY_LIST actions', async () => {
    ...
    it('dispatches FETCH_TOPOLOGY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOPOLOGY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOPOLOGY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOPOLOGY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOPOLOGY actions', async () => {
      const expectedActions = [
        {
