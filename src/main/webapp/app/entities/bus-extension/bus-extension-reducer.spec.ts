...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BUSEXTENSION_LIST actions', async () => {
    ...
    it('dispatches FETCH_BUSEXTENSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BUSEXTENSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BUSEXTENSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BUSEXTENSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BUSEXTENSION actions', async () => {
      const expectedActions = [
        {
