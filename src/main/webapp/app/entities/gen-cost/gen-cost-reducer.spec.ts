...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './gen-cost.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GENCOST_LIST actions', async () => {
    ...
    it('dispatches FETCH_GENCOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GENCOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GENCOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GENCOST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GENCOST actions', async () => {
      const expectedActions = [
        {
