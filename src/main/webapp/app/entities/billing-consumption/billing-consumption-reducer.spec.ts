...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './billing-consumption.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BILLINGCONSUMPTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_BILLINGCONSUMPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BILLINGCONSUMPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BILLINGCONSUMPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BILLINGCONSUMPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BILLINGCONSUMPTION actions', async () => {
      const expectedActions = [
        {
