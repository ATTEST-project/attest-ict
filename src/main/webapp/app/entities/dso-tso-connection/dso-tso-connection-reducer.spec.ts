...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './dso-tso-connection.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DSOTSOCONNECTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_DSOTSOCONNECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DSOTSOCONNECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DSOTSOCONNECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DSOTSOCONNECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DSOTSOCONNECTION actions', async () => {
      const expectedActions = [
        {
