...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOLARDATA_LIST actions', async () => {
    ...
    it('dispatches FETCH_SOLARDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SOLARDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SOLARDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SOLARDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SOLARDATA actions', async () => {
      const expectedActions = [
        {
