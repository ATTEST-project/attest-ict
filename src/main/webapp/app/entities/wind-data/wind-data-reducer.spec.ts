...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './wind-data.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WINDDATA_LIST actions', async () => {
    ...
    it('dispatches FETCH_WINDDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WINDDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WINDDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WINDDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WINDDATA actions', async () => {
      const expectedActions = [
        {
