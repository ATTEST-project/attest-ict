...
function T25DayAhead(props) {
  ...
  const handleUpload = e => {
    ...
    formdata.append('tool', 'T25_dayahead');

    /* eslint-disable-next-line no-console */
    console.log('upload input file button clicked!');
    // console.log('call uploadInput for T25_dayahead')
  ...
  const handleSubmit1 = event => {
    ...
    formData.append('networkName', networkName);
    axios
      .post('/api/tools/run/T25-day-ahead', formData)
      .then(res => {
        /* eslint-disable-next-line no-console */
        console.log(res);
        setLoading1(false);
      ...
      .catch(err => {
        ...
        setShowAlert(true);
        setSeverity('error');
        setMessage('Problem running Day Ahead tool');
        setLoading1(false);
      });
  };
  ...
  return (
    <div>
      <div className="containerT41">
        <div className={'title'}>Day Ahead Optimization Tool</div>
