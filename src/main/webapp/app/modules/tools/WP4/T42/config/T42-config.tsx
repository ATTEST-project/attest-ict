...
const T42Config = (props: any) => {
  ...
  // const toolNum = 'T41';
  // const toolFileNameKeys = ['_output']; // T41 output file must contains this keyword
      ...
      dispatch(
        ...
        .then(res => {
          if (res.data.status === 'ko') {
            ...
            toast.success('T42 Tool is running!');
        ...
        <>
          ...
          <FormProvider {...methods}>
            <Form onSubmit={handleSubmit(submitMethod)}>
              ...
              <Auxiliary enableUploadOtherToolResults={enableUploadT41Results} />
