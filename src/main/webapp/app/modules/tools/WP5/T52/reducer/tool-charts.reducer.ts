...
export const T52ToolShowChartsSlice = createEntitySlice({
  name: 't52_tool_show_charts',
  initialState,
...
export const { reset } = T52ToolShowChartsSlice.actions;

export default T52ToolShowChartsSlice.reducer;
