...
export const T511ToolShowTableSlice = createEntitySlice({
  name: 't511_tool_show_table',
  initialState,
...
export const { reset } = T511ToolShowTableSlice.actions;

export default T511ToolShowTableSlice.reducer;
