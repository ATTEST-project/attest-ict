...
export const T511ToolShowChartsSlice = createEntitySlice({
  name: 't511_tool_show_charts',
  initialState,
...
export const { reset } = T511ToolShowChartsSlice.actions;

export default T511ToolShowChartsSlice.reducer;
