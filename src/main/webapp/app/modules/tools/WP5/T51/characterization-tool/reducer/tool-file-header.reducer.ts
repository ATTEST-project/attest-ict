...
export const T511ToolFileHeaderSlice = createEntitySlice({
  name: 't511_tool_file_header',
  initialState,
...
export const { reset } = T511ToolFileHeaderSlice.actions;

export default T511ToolFileHeaderSlice.reducer;
