...
export const T512ToolShowTableSlice = createEntitySlice({
  name: 't512_tool_show_table',
  initialState,
...
export const { reset } = T512ToolShowTableSlice.actions;

export default T512ToolShowTableSlice.reducer;
