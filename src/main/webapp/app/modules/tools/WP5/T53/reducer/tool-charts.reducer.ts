...
export const T53ToolShowChartsSlice = createEntitySlice({
  name: 't53_tool_show_charts',
  initialState,
...
export const { reset } = T53ToolShowChartsSlice.actions;

export default T53ToolShowChartsSlice.reducer;
