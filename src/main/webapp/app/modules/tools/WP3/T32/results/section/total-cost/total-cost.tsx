...
const TotalCost = (props: any) => {
  ...
  console.log('T32 Total Cost start ');
  const jsonResponse = useAppSelector(state => state.t32ToolResults.entity);

  /* eslint-disable-next-line no-console */
  console.log('T32 jsonResponse ', jsonResponse);
  ...
  const getTotalCostData = () => {
    const totalCosts = Object.entries(jsonResponse)
      ...
      .map(([k, v]) => v);
    /* eslint-disable-next-line no-console */
    console.log('T32 Total Costs: ', totalCosts);
    const data = [];
    ...
    <div className="section-with-border">
      ...
      <Table>
        ...
        <tbody>
          ...
          <tr>
            <td>Branch</td>
            <td>{jsonResponse['Scenario 1']['Branch investment cost (EUR-million)']}</td>
            <td>{jsonResponse['Scenario 2']['Branch investment cost (EUR-million)']}</td>
          </tr>
          <tr>
            <td>Flex</td>
