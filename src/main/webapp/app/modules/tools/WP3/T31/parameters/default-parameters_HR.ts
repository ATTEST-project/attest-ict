export const defaultParametersHR: Readonly<any> = {
  line_capacities: [
  ...
  cont_list: [],
  line_length: [],
  growth: { Active: { '2020': 0, '2030': 2.4, '2040': 1.7, '2050': 3.9 }, Slow: { '2020': 0, '2030': 2.0, '2040': 1.0, '2050': 1.0 } },
  ...
  add_load_data_case_name: 'HR_Dx_01_',
};
